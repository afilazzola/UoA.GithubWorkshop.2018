...
The final item is to make the plot. That part is simple with calling `plotOutput` and the `plot` output from our server. 

The rest of the code here is to pretty up our User Interface by generating a side panel. 